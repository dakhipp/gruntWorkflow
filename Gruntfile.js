...
module.exports = function(grunt) {
  grunt.initConfig({
    ...
    files: {
      ...
      js: {
        vendor: ['public/dev/bower_components/jquery/jquery.js', 'public/dev/bower_components/angular/angular.js', 'public/dev/bower_components/angular-route/angular-route.js']
      },
      coffee: {
        dest: 'public/dev/js/**'
      },
    ...
    uglify: {
      build: {
        files: {
          "public/deploy/js/app.min.js": ["<%= files.js.vendor %>", "public/dev/js/**/*.js", "public/dev/temp/templates.js"]
        }
      }
    },
    imagemin: {
  ...
  return grunt.registerTask('zip', ['compress']);
};
